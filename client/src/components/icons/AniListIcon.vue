<template>
  <div aria-hidden="true" class="bg-[#19212D] flex items-center justify-center rounded-md">
    <svg class="w-5 h-5" viewBox="0 0 4.233 4.233" xmlns="http://www.w3.org/2000/svg">
