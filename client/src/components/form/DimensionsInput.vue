...
type EventHandler = { event: Event, type: Focused }
    ...
    >
      ...
      <div class="flex gap-4 items-center w-full px-3 pb-2 pt-1">
        <input
          ref="widthInput"
          :class="[
            'grow min-w-0 bg-white dark:bg-gray-950 rounded-md',
            'dark:text-gray-200 border-0 focus:outline-none',
            'focus:ring  motion-safe:transition-shadow',
            'placeholder:text-gray-500 h-6 px-1.5 text-right',
            'motion-safe:transition tabular-nums',
            invalidWidth 
        ...
        <span
          :class="[
            'shrink-0 text-center select-none',
            'text-gray-500'
          ]"
        >
          &times;
        ...
        <span
          :class="[
            'shrink-0 text-center text-sm/none select-none',
            'text-gray-500'
          ]"
        >
          cm
